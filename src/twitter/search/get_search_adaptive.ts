...
import { SearchAdaptiveParam, SearchAdaptiveExtType as Ext, SetExtType } from "../../types/variables/search_adaptive.ts"
import { SearchAdaptiveRes } from "../../types/response/search_adaptive.ts"

export const getSearchAdaptive = async (variables: SearchAdaptiveParam) => {
    const res = await TQLRequest(SearchAdaptive, {
